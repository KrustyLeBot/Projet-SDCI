...
class Monitor {
    ...
    private double get_data() {
        ...
        try {
            ...
            Process process = Runtime.getRuntime().exec("sudo docker exec mn.monitoring curl http://localhost:8080/monitor/10.0.0.11/8080");
            ...
            res = (Double) Float.parseFloat(output.toString());
