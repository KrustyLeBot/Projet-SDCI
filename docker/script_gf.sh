...
node device.js --local_ip "${1}" --local_port 9004 --local_name "dev4" --remote_ip "${1}" --remote_port 8080 --remote_name "gwf" --send_period 1000 &
node device.js --local_ip "${1}" --local_port 9005 --local_name "dev5" --remote_ip "${1}" --remote_port 8080 --remote_name "gwf" --send_period 1000 &
